...
namespace Unit05.Game.Scripting
{
    ...
    /// <para>
    /// The responsibility of HandleCollisionsAction is to handle the situation when the Floor 
    /// collides with the food, or the Floor collides with its segments, or the game is over.
    /// </para>
    /// </summary>
